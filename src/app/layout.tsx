 ...
 *
 * 예전에는 `FLOW_REDIRECT_URI`(OAuth 콜백 주소)에서 origin만 떼어 썼다. OAuth를 걷어내면서
 * 그 값이 사라졌는데, 도메인 하나 때문에 환경변수를 새로 만들 필요는 없다 — Vercel이
 * `VERCEL_PROJECT_PRODUCTION_URL`을 자동으로 넣어 준다. 없으면(로컬·테스트) 개발 서버다.
 */
