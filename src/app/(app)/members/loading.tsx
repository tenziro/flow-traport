import { HeadSkeleton, MemberRowsSkeleton, TabBarSkeleton } from "@/components/skeletons";
 ...
 *
 * 부서 카드는 하나만 그린다. 부서가 몇 개인지는 서버가 답을 줘야 알고, 모르는 수를 지어
