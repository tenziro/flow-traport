...
/**
 * 멘션 그룹 아래의 **읽음으로 만들기** (PRD §13 A2). 워크리스트 멘션에는 알림 ID가 없어서
 * 예전에는 flow로 넘어가야 했다 — REST 알림이 `alarmId`를 주면서 여기서 처리할 수 있게 됐다
 * (api-spec §7.2).
 *
 * `댓글 다 보기`는 v1.3.0에 없앴다 — 모달이 열릴 때 스레드를 이미 편다 (`MentionDetail`).
 *
