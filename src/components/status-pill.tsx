...
/**
 * 업무 상태 배지. 색은 flow 화면이 쓰는 것을 그대로 따른다 — 콕핏에서 다른 색을 쓰면
 * 같은 상태를 두 번 배워야 한다.
 *
...
export const STATUS_TONE = {
  요청: { chip: "bg-info-bg text-info-foreground", dot: "bg-info", text: "text-info-foreground" },
  진행: {
  ...
  완료: { chip: "bg-done-bg text-done-foreground", dot: "bg-done", text: "text-done-foreground" },
  보류: {
...
const UNKNOWN = { chip: "bg-secondary text-muted-foreground", dot: "bg-neutral" };
