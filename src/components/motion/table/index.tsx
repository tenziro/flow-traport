...
// 3. 머리 줄 아래 선: `border-b` → 안쪽 그림자 (`HEADER_EDGE_SHADOW`). 표가
//    `border-collapse`라 셀 테두리를 표 격자가 그리는데, 격자는 `sticky`를 안 따라와서
//    줄을 내리면 머리 칸만 남고 그 아래 선이 사라졌다.
// 4. 정렬 표시: ∧ 하나를 돌려 쓰던 것을 세 그림으로 갈랐다 (`sort-v` / ↑ / ↓).
//    안 누른 칸의 흐린 ∧가 "정렬 안 됨"인지 "오름차순"인지 안 갈렸다.
//
// 나머지 동작·구조는 원본 그대로다.
